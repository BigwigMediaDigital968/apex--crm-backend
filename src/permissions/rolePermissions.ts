...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.CALL_RECORDING_LISTEN,

    // Stringee Numbers
    PERMISSIONS.STRINGEE_NUMBER_CREATE,
    PERMISSIONS.STRINGEE_NUMBER_UPDATE,
    PERMISSIONS.STRINGEE_NUMBER_VIEW,
    PERMISSIONS.STRINGEE_NUMBER_ASSIGN,
    PERMISSIONS.STRINGEE_NUMBER_DELETE,
  ...
  [ROLES.EMPLOYEE]: [
    ...
    PERMISSIONS.LATE_CHECKIN_SUBMIT,
